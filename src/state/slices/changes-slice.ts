...
const generateMockChanges = (): ChangeRequest[] => {
  return [
    {
      id: "CR-2026-0001",
      title: "Update invoice approval workflow in NICOR (Net Suite)",
      ...
      systemAffected: "NICOR (Net Suite)",
    ...
    {
      id: "CR-2026-0002",
      title: "CLM contract field validation update",
      description: "Add required field validation for the contract effective date and update picklist values for the Contract Type field.",
      systemAffected: "CLM",
      category: "Update Existing System",
      businessJustification: "Operations team has been entering incomplete contract data, leading to inaccurate contract tracking reports.",
      ...
      testPlan: "Verify field validation triggers on contract save. Test picklist values are updated correctly.",
      testSteps: [
        { id: "ts-1", description: "Create new contract without effective date", expectedOutcome: "Validation error displayed", result: "pass", notes: "Working as expected", completedBy: "elena.r@company.com", completedAt: "2026-06-13T10:00:00Z" },
        { id: "ts-2", description: "Verify Contract Type picklist values", expectedOutcome: "New values appear in dropdown", result: "pass", notes: "All 12 values present", completedBy: "elena.r@company.com", completedAt: "2026-06-13T10:30:00Z" },
      ],
      evidence: [
      ...
      comments: [
        { id: "c-1", authorId: "adeyinka@company.com", authorName: "Adeyinka Akinsanya", content: "Please make sure the picklist values match the approved list from the contracts team.", timestamp: "2026-06-12T13:45:00Z" },
        { id: "c-2", authorId: "marcus.v@company.com", authorName: "Marcus Vance", content: "Confirmed — using the exact list from the Contracts Ops email dated June 5.", timestamp: "2026-06-12T13:50:00Z", parentId: "c-1" },
      ],
      isQueried: false,
    ...
    {
      id: "CR-2026-0003",
      title: "NICOR (Net Suite) vendor master data migration",
      description: "Migrate 2,500 vendor master records from the legacy ERP system into NICOR (Net Suite), including bank details and payment terms.",
      systemAffected: "NICOR (Net Suite)",
      category: "Update Existing System",
    ...
    {
      id: "CR-2026-0005",
      title: "Board dashboard — monthly KPI report",
      description: "Create a new Board dashboard showing monthly KPIs including revenue, headcount, and project completion rates.",
      systemAffected: "Board",
    ...
    },
    {
      ...
      aiRequest: {
        ...
        llmChoices: ["Claude"],
        integratesWithSystems: ["NICOR (Net Suite)"],
      ...
      deployment: {
        ...
        notes: "Script deployed as a scheduled NICOR (Net Suite) integration step; first live batch reviewed manually as a sanity check.",
        verificationStatus: "confirmed",
    ...
    },
    {
      ...
      aiRequest: {
        ...
        usesDefaultStack: "Yes",
        llmChoices: ["Claude"],
        integratesWithSystems: ["NICOR Forms"],
    ...
    {
      id: "CR-2026-0011",
      title: "Travel Authorization expense limit update",
      description: "Update the per-diem and expense limits configured in Travel Authorization to match the new 2026 travel policy.",
      systemAffected: "Travel Authorization",
      category: "Update Existing System",
