...
const mockUsers: UserProfile[] = [
  {
    ...
    initials: "AA",
    department: "IT",
    baseRoles: ["Requester", "Approver", "Tester", "Admin", "IT Manager", "Security Officer"],
    firstName: "Adeyinka",
    lastName: "Akinsanya",
  ...
  },
  {
    ...
    initials: "SJ",
    department: "Finance",
    baseRoles: ["Requester", "Approver", "Department Lead"],
    firstName: "Sarah",
    lastName: "Jenkins",
  ...
  },
  {
    ...
    baseRoles: ["Requester", "Approver", "Tester", "Admin", "IT Manager", "CAB", "CTO / Executive Sponsor"],
    firstName: "Marcus",
    lastName: "Vance",
  ...
  },
  {
    ...
    initials: "ER",
    department: "HR",
    baseRoles: ["Requester", "Approver", "Tester", "CAB", "Security Officer"],
    firstName: "Elena",
    lastName: "Rostova",
